...
class Jenis extends CI_Controller {
	...
	public function tambah()
	{
		...
		$valid->set_rules('NAMA_JENIS_BARANG','Nama_jenis','required|min_length[5]|max_length[32]|is_unique[JENIS_BARANG.NAMA_JENIS_BARANG]',
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'NAMA_JENIS_BARANG'			=> $i->post('NAMA_JENIS_BARANG'));
	...
	public function edit($id_jenis)
	{
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'ID_JENIS_BARANG'			=> $id_jenis,
							'NAMA_JENIS_BARANG'		=> $i->post('NAMA_JENIS')
						);
